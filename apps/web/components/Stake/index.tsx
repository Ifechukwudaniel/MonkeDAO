...
export const Stake = () => {
  ...
  const getAPY = (duration: string): number => {
    switch (duration) {
      case '30':
        return 12;
      case '90':
  ...
  const getTier = (duration: string): 'BRONZE' | 'SILVER' | 'GOLD' => {
    switch (duration) {
      case '30':
        return 'BRONZE';
      case '90':
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <button
            ...
            className={`px-8 py-3 font-bold transition-all border-2 ${
              selectedTab === 'token'
                ...
                : 'bg-white text-gray-700 border-border-default hover:border-primary'
            }`}
          >
        ...
        {selectedTab === 'token' && (
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <div className="bg-white border-2 border-border-default p-6">
              ...
              <div className="bg-white border-2 border-border-default p-6">
                ...
                <div className="text-2xl font-bold text-primary">580,000</div>
                <div className="text-xs text-gray-600 mt-1">DEAL_TOKENS</div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white border-2 border-border-default p-6">
                  ...
                  <div className="bg-secondary border-2 border-border-default p-4">
                    <div className="text-xs text-gray-600 mb-2">
                      &gt; WALLET_BALANCE
                    </div>
                ...
                <div className="bg-white border-2 border-border-default p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-2 border-primary bg-secondary p-4">
                      <div className="flex justify-between items-center mb-3">
              ...
              <div className="lg:col-span-1">
                <div className="bg-white border-2 border-primary p-6 sticky top-6">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="0.00"
                        className="w-full border-2 border-border-default p-3 font-bold text-lg focus:outline-none focus:border-primary"
                      />
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center justify-between border-2 border-border-default p-3 cursor-pointer hover:border-primary transition-colors">
                  ...
                  {/* Summary */}
                  <div className="bg-secondary border-2 border-border-default p-4 mb-6">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="border-t-2 border-border-default pt-2 mt-2">
                        <div className="flex justify-between">
                  ...
                  {/* Stake Button */}
                  <button className="w-full bg-primary hover:bg-[#3d7a4d] text-white font-bold py-4 transition-all border-2 border-primary mb-4">
                    STAKE_TOKENS
                  </button>
        ...
        {selectedTab === 'nft' && (
          <div className="max-w-6xl mx-auto">
            <div className="bg-white border-2 border-border-default p-8 relative">
              {/* Coming Soon Badge */}
              <div className="absolute top-0 right-0 bg-primary text-white px-6 py-2 font-bold text-sm border-l-2 border-b-2 border-border-default">
                [COMING_SOON]
              </div>

              <div className="flex items-start gap-4 mb-8 pb-6 border-b-2 border-border-default">
                <div className="border-2 border-primary p-3">
                  <Ticket className="w-8 h-8 text-primary" strokeWidth={1.5} />
                </div>
                <div>
              ...
              {/* How It Works */}
              <div className="bg-secondary border-2 border-border-default p-6 mb-8">
                <h3 className="text-xl font-bold mb-6 flex items-center gap-2">
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  <div className="flex items-start gap-3">
                    <div className="border-2 border-primary w-8 h-8 flex items-center justify-center flex-shrink-0 font-bold">
                      1
                    </div>
                    <div>
              ...
              <div className="mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-secondary border-2 border-border-default p-6">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-12 h-12 border-2 border-primary flex items-center justify-center font-bold text-xl">
                        S
                      </div>
                      <div>
              ...
              <div className="bg-secondary border-2 border-border-default p-6 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="border-2 border-primary p-2 flex-shrink-0">
                      <Clock
                        className="w-5 h-5 text-primary"
                        strokeWidth={1.5}
                      />
              ...
              <div className="bg-secondary border-2 border-primary p-6 text-center">
                ...
                <button className="bg-white border-2 border-border-default text-gray-600 font-bold py-3 px-6 cursor-not-allowed">
                  NOTIFY_ME_WHEN_LIVE
                </button>
              </div>
            </div>
