          ...
          >
            {step.status === 'complete' ? (
              <>
                ...
                <div className="relative flex h-8 w-8 items-center justify-center rounded-full bg-[#ffffff20] hover:bg-primary">
            ...
            <span className="absolute left-1/2 -translate-x-1/2 mt-3 text-sm font-medium">
              {step.name}
            </span>
          </li>
        ))}
