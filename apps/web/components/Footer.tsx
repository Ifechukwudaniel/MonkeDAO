...
export const Footer = () => {
  return (
    <footer className="  border-t border-[#1f492a] mt-20">
      <div className=" mx-auto grid grid-cols-2 items-center sm:items-start justify-between gap-8">
        {/* Project Info */}
        <div className="px-6 py-10 ">
          <h2 className="text-xl font-semibold">Monke Deals</h2>
      ...
      {/* Credits / Disclaimer */}
      <div className="border-t border-[#1f492a] px-6 py-5 text-center text-xs text-neutral-500 leading-relaxed">
        <p>
